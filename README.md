...
- Personalize: easily create new art files (just add one to ``<path_to_arttime_directory>/share/arttime/textart`` directory), and personalize the default message that is shown under each art (message is picked from first line of every file). Art has a power to inspire, putting hate messages would be violation of [CFLA](https://github.com/reportaman/arttime/blob/23360507eb5622d951728b5f71621a1df942e157/LICENSE_ADDENDUM_CFLA), so be mindful.
