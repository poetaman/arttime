...
- Copy and paste the following complete line in terminal window, and press ``Enter``. Note: hovering your computer mouse on the right end of the following line will show a button, clicking it will copy the line for you (or else you will have to press and hold to the mouse to scroll and select the entire line from beginning to end).
```
